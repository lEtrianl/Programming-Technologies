...
class Paint(Frame):
    ...
    def setUI(self):
        ...
        three_btn = Button(self, text="Eight", width=10,
                         command=lambda: self.set_brush_size(8))
        three_btn.grid(row=1, column=3)

        four_btn = Button(self, text="Eleven", width=10,
                         command=lambda: self.set_brush_size(11))
        four_btn.grid(row=1, column=4)

        five_btn = Button(self, text="Fifty", width=10,
